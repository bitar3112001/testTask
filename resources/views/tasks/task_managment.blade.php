<x-sidebar>
    ...
    <div class="col-lg-3 col-xs-12">
        <div id="projectname" data-projectid="{{$project_id}}" class="Project_name">project name/{{$project_name}}</div>
                        ...
                        <div class="created_tasks">
                            @foreach($tasks as $task)
                                @if($board->id == $task->board_id)
                                    <div data-task_id="{{$task->id}}" class="task_elements box-content" draggable="true">
