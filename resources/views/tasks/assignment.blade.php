                ...
                <form action="/admin/assignment" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="deploy_date" class="form-control"
                                placeholder="Enter deploy date" required>
                        </div>
                        <div class="form-group">
                            <label for="submit_date">Submit Date</label>
                            <input type="date" name="submit_date" class="form-control"
                                placeholder="Enter submit date" required>
                        </div>
                        <div class="form-group">
                            <label>Type</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type" id="project"
                                    value="project" required>
                                <label class="form-check-label" for="project">Project</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type" id="task"
                                    value="task" required>
    ...
    <table class="table table-striped table-bordered" id="datatable">
        ...
        <tbody>
            @forelse($projects as $project)
                            ...
                            <form action="/admin/assignment/{{ $project->id }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="edit_name{{ $project->id }}"
                                            class="form-control" placeholder="Change name"
                                            value="{{ $project->name }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="edit_deploy_date{{ $project->id }}">deploy date </label>
                                        <input type="date" name="deploy_date"
                                            id="edit_deploy_date{{ $project->id }}" class="form-control"
                                            placeholder="Change deploy date " value="{{ $project->deploy_date }}"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label for="edit_submit_date{{ $project->id }}">Submit Date</label>
                                        <input type="date" name="submit_date"
                                            id="edit_submit_date{{ $project->id }}" class="form-control"
                                            placeholder="Change submit date" value="{{ $project->submit_date }}"
                                            required>
                                    </div>
                                </div>
                                <div class="modal-footer">
                ...
                <!-- End Modal -->
                <div class="modal fade" id="endModal{{ $project->id }}" tabindex="-1" role="dialog"
                    aria-labelledby="endModalLabel{{ $project->id }}" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
