...
<body>
    ...
    <div id="single-wrapper">
        <form action="/regis" method="post" class="frm-single">
            @csrf
            <div class="inside">
                ...
                <!-- /.frm-title -->
                <div class="frm-input"><input type="email" placeholder="email" name="email" class="frm-inp"><i class="fa fa-envelope frm-ico"></i></div>
                <!-- /.frm-input -->
                <div class="frm-input"><input type="text" placeholder="name" name="name" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
                <!-- /.frm-input -->
